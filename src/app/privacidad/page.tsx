      ...
      <Container>
        <article className='mx-auto max-w-4xl rounded-3xl border border-border bg-background p-8 shadow-lg md:p-12'>
          ...
          <p className='mt-8 text-lg leading-relaxed text-foreground'>
            Este sitio utiliza los datos enviados voluntariamente a través del formulario de contacto únicamente para responder consultas relacionadas con Transporte Libertador.
          </p>
